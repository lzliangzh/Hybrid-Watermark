# Gaussian Shading & RingID Watermark
...
class Gaussian_Shading_chacha:
    def __init__(self, ch_factor, hw_factor, fpr, user_number, generator):
        self.ch = ch_factor
        self.hw = hw_factor
    ...
    def create_watermark_and_return_w(self):
        self.watermark = torch.randint(0, 2, [1, 4 // self.ch, 64 // self.hw, 64 // self.hw], generator=self.generator, device="cuda")
